...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function $o(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ra(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Jo(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ra(),fragmentShader:`
...
`),r=[];for(let l=0,h=n.length;l<h;l++){let d=n[l].trimStart();if(d.length===0)continue;let s=d.charAt(0);if(s!=="#")if(s==="v"){let o=d.split(Vl);switch(o[0]){case"v":t.vertices.push(parseFloat(o[1]),parseFloat(o[2]),parseFloat(o[3])),o.length>=7?($r.setRGB(parseFloat(o[4]),parseFloat(o[5]),parseFloat(o[6])).convertSRGBToLinear(),t.colors.push($r.r,$r.g,$r.b)):t.colors.push(void 0,void 0,void 0);break;case"vn":t.normals.push(parseFloat(o[1]),parseFloat(o[2]),parseFloat(o[3]));break;case"vt":t.uvs.push(parseFloat(o[1]),parseFloat(o[2]));break}}else if(s==="f"){let u=d.slice(1).trim().split(Vl),f=[];for(let _=0,p=u.length;_<p;_++){let m=u[_];if(m.length>0){let y=m.split("/");f.push(y)}}let g=f[0];for(let _=1,p=f.length-1;_<p;_++){let m=f[_],y=f[_+1];t.addFace(g[0],m[0],y[0],g[1],m[1],y[1],g[2],m[2],y[2])}}else if(s==="l"){let o=d.substring(1).trim().split(" "),u=[],f=[];if(d.indexOf("/")===-1)u=o;else for(let g=0,_=o.length;g<_;g++){let p=o[g].split("/");p[0]!==""&&u.push(p[0]),p[1]!==""&&f.push(p[1])}t.addLineGeometry(u,f)}else if(s==="p"){let u=d.slice(1).trim().split(" ");t.addPointGeometry(u)}else if((r=Sm.exec(d))!==null){let o=(" "+r[0].slice(1).trim()).slice(1);t.startObject(o)}else if(Em.test(d))t.object.startMaterial(d.substring(7).trim(),t.materialLibraries);else if(bm.test(d))t.materialLibraries.push(d.substring(7).trim());else if(Am.test(d))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(s==="s"){if(r=d.split(" "),r.length>1){let u=r[1].trim().toLowerCase();t.object.smooth=u!=="0"&&u!=="off"}else t.object.smooth=!0;let o=t.object.currentMaterial();o&&(o.smooth=t.object.smooth)}else{if(d==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+d+'"')}}t.finalize();let a=new gn;if(a.materialLibraries=[].concat(t.materialLibraries),!(t.objects.length===1&&t.objects[0].geometry.vertices.length===0)===!0)for(let l=0,h=t.objects.length;l<h;l++){let d=t.objects[l],s=d.geometry,o=d.materials,u=s.type==="Line",f=s.type==="Points",g=!1;if(s.vertices.length===0)continue;let _=new Lt;_.setAttribute("position",new it(s.vertices,3)),s.normals.length>0&&_.setAttribute("normal",new it(s.normals,3)),s.colors.length>0&&(g=!0,_.setAttribute("color",new it(s.colors,3))),s.hasUVIndices===!0&&_.setAttribute("uv",new it(s.uvs,2));let p=[];for(let y=0,v=o.length;y<v;y++){let E=o[y],R=E.name+"_"+E.smooth+"_"+g,w=t.materials[R];if(this.materials!==null){if(w=this.materials.create(E.name),u&&w&&!(w instanceof Bn)){let T=new Bn;Tt.prototype.copy.call(T,w),T.color.copy(w.color),w=T}else if(f&&w&&!(w instanceof bn)){let T=new bn({size:10,sizeAttenuation:!1});Tt.prototype.copy.call(T,w),T.color.copy(w.color),T.map=w.map,w=T}}w===void 0&&(u?w=new Bn:f?w=new bn({size:1,sizeAttenuation:!1}):w=new Hr,w.name=E.name,w.flatShading=!E.smooth,w.vertexColors=g,t.materials[R]=w),p.push(w)}let m;if(p.length>1){for(let y=0,v=o.length;y<v;y++){let E=o[y];_.addGroup(E.groupStart,E.groupCount,y)}u?m=new Fi(_,p):f?m=new gi(_,p):m=new gt(_,p)}else u?m=new Fi(_,p[0]):f?m=new gi(_,p[0]):m=new gt(_,p[0]);m.name=d.name,a.add(m)}else if(t.vertices.length>0){let l=new bn({size:1,sizeAttenuation:!1}),h=new Lt;h.setAttribute("position",new it(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(h.setAttribute("color",new it(t.colors,3)),l.vertexColors=!0);let d=new gi(h,l);a.add(d)}return a}};function ql(i,e=1e-4){e=Math.max(e,Number.EPSILON);let t={},n=i.getIndex(),r=i.getAttribute("position"),a=n?n.count:r.count,c=0,l=Object.keys(i.attributes),h={},d={},s=[],o=["getX","getY","getZ","getW"],u=["setX","setY","setZ","setW"];for(let y=0,v=l.length;y<v;y++){let E=l[y],R=i.attributes[E];h[E]=new ht(new R.array.constructor(R.count*R.itemSize),R.itemSize,R.normalized);let w=i.morphAttributes[E];w&&(d[E]=new ht(new w.array.constructor(w.count*w.itemSize),w.itemSize,w.normalized))}let f=e*.5,g=Math.log10(1/e),_=Math.pow(10,g),p=f*_;for(let y=0;y<a;y++){let v=n?n.getX(y):y,E="";for(let R=0,w=l.length;R<w;R++){let T=l[R],z=i.getAttribute(T),S=z.itemSize;for(let A=0;A<S;A++)E+=`${~~(z[o[A]](v)*_+p)},`}if(E in t)s.push(t[E]);else{for(let R=0,w=l.length;R<w;R++){let T=l[R],z=i.getAttribute(T),S=i.morphAttributes[T],A=z.itemSize,k=h[T],q=d[T];for(let ee=0;ee<A;ee++){let P=o[ee],O=u[ee];if(k[O](c,z[P](v)),S)for(let V=0,X=S.length;V<X;V++)q[V][O](c,S[V][P](v))}}t[E]=c,s.push(c),c++}}let m=i.clone();for(let y in i.attributes){let v=h[y];if(m.setAttribute(y,new ht(v.array.slice(0,c*v.itemSize),v.itemSize,v.normalized)),y in d)for(let E=0;E<d[y].length;E++){let R=d[y][E];m.morphAttributes[y][E]=new ht(R.array.slice(0,c*R.itemSize),R.itemSize,R.normalized)}}return m.setIndex(s),m}var Hn,ki,Vn,on=null,Kr=!1,Ia=0;function Yl(){let i=document.querySelector(".header-bg");if(!i)return;Hn=new Br;let e=i.getBoundingClientRect();ki=new St(75,e.width/e.height,.1,1e3),ki.position.set(0,2,5),Vn=new Ni({canvas:i,alpha:!0,antialias:!0}),Vn.setSize(e.width,e.height),Vn.setPixelRatio(window.devicePixelRatio),Vn.shadowMap.enabled=!0,Vn.shadowMap.type=ba;let t=new Xr(16777215,.5);Hn.add(t);let n=new Gr(16777215,4473924,.4);n.position.set(0,20,0),Hn.add(n);let r=new Wr(16777215,1.2);r.position.set(10,20,15),r.castShadow=!0,r.shadow.mapSize.width=2048,r.shadow.mapSize.height=2048,r.shadow.radius=8;let a=r.shadow.camera;a.left=-10,a.right=10,a.top=10,a.bottom=-10,a.near=.5,a.far=50,Hn.add(r);let c=new Ui(10,10),l=new zr({opacity:.5}),h=new gt(c,l);h.rotation.x=-Math.PI/2,h.receiveShadow=!0,Hn.add(h);let d=new Jr;d.setPath("/static/app/docs/"),d.load("estilografica.obj",s=>{on=s;let o=new kr({color:8947848,metalness:.3,roughness:.5,side:kt,transparent:!1,opacity:1,depthWrite:!0,depthTest:!0});on.traverse(u=>{u instanceof gt&&(u.castShadow=!0,u.receiveShadow=!0,u.material=o,u.geometry&&(u.geometry=ql(u.geometry),u.geometry.computeVertexNormals()))}),on.position.set(3,0,0),on.scale.set(.5,.5,.5),Hn.add(on)}),window.addEventListener("mousedown",Rm),window.addEventListener("mouseup",Cm),window.addEventListener("mousemove",Pm),window.addEventListener("resize",()=>Lm(i)),Zl()}function Rm(i){Kr=!0,Ia=i.clientX}function Cm(){Kr=!1}function Pm(i){if(Kr&&on){let e=i.clientX-Ia;on.rotation.y+=e*.01,Ia=i.clientX}}function Lm(i){i.style.width="",i.style.height="";let e=i.getBoundingClientRect();ki.aspect=e.width/e.height,ki.updateProjectionMatrix(),Vn.setSize(e.width,e.height)}function Zl(){requestAnimationFrame(Zl),on&&!Kr&&(on.rotation.y+=.003),Vn.render(Hn,ki)}function $l(){let i=document.getElementById("navbar");if(!i)return;let e=i.querySelector(".navbar-hamburger");e&&(e.addEventListener("click",()=>{let t=i.classList.toggle("is-open");e.setAttribute("aria-expanded",String(t))}),document.addEventListener("click",t=>{i.contains(t.target)||(i.classList.remove("is-open"),e.setAttribute("aria-expanded","false"))}),i.querySelectorAll(".navbar-mobile-menu .navbar-btn").forEach(t=>{t.closest(".dropdown-wrapper")||t.addEventListener("click",()=>{i.classList.remove("is-open"),e.setAttribute("aria-expanded","false")})}))}function Jl(){document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();let n=e.getAttribute("href")?.slice(1);if(n){let r=document.getElementById(n);r&&(r.scrollIntoView({behavior:"smooth",block:"start"}),history.pushState(null,"",`#${n}`))}})})}function Im(){let i=document.cookie.match(/csrftoken=([^;]+)/);return i?decodeURIComponent(i[1]):""}async function Gn(i,e){return(await fetch(i,{method:"POST",headers:{"X-CSRFToken":Im()},body:e})).json()}function tc(){try{return JSON.parse(document.getElementById("task-groups-data")?.textContent??"[]")}catch{return[]}}var bt=null,jr=null;function Dm(){if(bt=document.getElementById("task-discard-modal"),!bt)return;let i=bt.querySelector("#modal-backdrop"),e=bt.querySelector("#modal-cancel"),t=bt.querySelector("#modal-confirm"),n=bt.querySelector("#modal-reason"),r=bt.querySelector("#modal-error"),a=()=>{bt.setAttribute("hidden",""),jr=null,n&&(n.value=""),r&&r.setAttribute("hidden","")};e?.addEventListener("click",a),i?.addEventListener("click",a),document.addEventListener("keydown",c=>{c.key==="Escape"&&bt&&!bt.hasAttribute("hidden")&&a()}),t?.addEventListener("click",async()=>{if(!jr)return;let c=n?.value.trim()??"";if(!c){r&&(r.textContent="Cal un motiu.",r.removeAttribute("hidden")),n?.focus();return}let l=t;l.disabled=!0;let d=document.querySelector(`[data-task-id="${jr}"]`)?.getAttribute("data-discard-url")??"",s=new URLSearchParams({reason:c}),o=await Gn(d,s);l.disabled=!1,o.ok?(nc(o.affected_ids,"discarded"),a()):r&&(r.textContent=o.error??"Error.",r.removeAttribute("hidden"))})}function Um(i,e){if(!bt)return;jr=i;let t=bt.querySelector("#modal-task-title");t&&(t.textContent=e);let n=bt.querySelector("#modal-reason");n&&(n.value="");let r=bt.querySelector("#modal-error");r&&r.setAttribute("hidden",""),bt.removeAttribute("hidden"),n?.focus()}var ln=null;function Nm(){let i=document.getElementById("task-popover"),e=document.getElementById("popover-box"),t=document.getElementById("popover-groups"),n=document.getElementById("popover-discard");if(!(!i||!e)){if(t){let r=document.createElement("button");r.type="button",r.className="group-swatch group-swatch-none js-swatch",r.title="Sense grup",r.textContent="\xD7",r.dataset.groupId="",r.addEventListener("click",()=>jl(null)),t.appendChild(r);for(let a of tc()){let c=document.createElement("button");c.type="button",c.className="group-swatch js-swatch",c.style.setProperty("--swatch-color",a.color),c.title=a.name,c.dataset.groupId=String(a.id),c.addEventListener("click",()=>jl(a.id)),t.appendChild(c)}}n?.addEventListener("click",()=>{if(ln===null)return;let a=document.querySelector(`[data-task-id="${ln}"]`)?.querySelector(".task-title")?.textContent??"";Qr(),Um(ln,a)}),document.addEventListener("click",r=>{if(i.hasAttribute("hidden"))return;let a=r.target;!i.contains(a)&&!a.closest?.(".js-edit-trigger")&&Qr()})}}function Kl(i,e){let t=document.getElementById("task-popover"),n=document.getElementById("popover-box"),r=document.getElementById("popover-groups");if(!t||!n)return;ln=i;let a=document.querySelector(`[data-task-id="${i}"]`);if(!a)return;let c=a.dataset.groupId??"";r?.querySelectorAll(".js-swatch").forEach(f=>{f.classList.toggle("active",f.dataset.groupId===c)}),t.removeAttribute("hidden");let l,h;if(e instanceof HTMLElement){let f=e.getBoundingClientRect();l=f.left,h=f.bottom+6}else l=e.x,h=e.y+4;let d=n.offsetWidth||180,s=n.offsetHeight||120,o=l,u=h;o+d>window.innerWidth-8&&(o=window.innerWidth-d-8),u+s>window.innerHeight-8&&(u=h-s-4),n.style.top=`${u+window.scrollY}px`,n.style.left=`${o}px`}function Qr(){document.getElementById("task-popover")?.setAttribute("hidden",""),ln=null}function Fm(i,e){i.dataset.groupId=e!==null?String(e):"";let t=i.querySelector(".task-group-badge");if(e!==null){let n=tc().find(r=>r.id===e);if(n)if(t)t.style.setProperty("--group-color",n.color),t.textContent=n.name;else{let r=document.createElement("span");r.className="task-group-badge",r.style.setProperty("--group-color",n.color),r.textContent=n.name,i.querySelector(".task-title")?.insertAdjacentElement("beforebegin",r)}}else t?.remove()}async function jl(i){if(ln===null)return;let e=document.querySelector(`[data-task-id="${ln}"]`);if(!e||!(await Gn(e.getAttribute("data-update-url")??"",new URLSearchParams({group:i!==null?String(i):""}))).ok)return;Fm(e,i),document.getElementById("popover-groups")?.querySelectorAll(".js-swatch").forEach(r=>{r.classList.toggle("active",r.dataset.groupId===(i!==null?String(i):""))})}function Om(i){if(i.hasAttribute("contenteditable"))return;let e=i.textContent??"";i.setAttribute("contenteditable","true"),i.focus();let t=document.createRange();t.selectNodeContents(i),window.getSelection()?.removeAllRanges(),window.getSelection()?.addRange(t);let n=async()=>{let r=i.textContent?.trim()??"";if(i.removeAttribute("contenteditable"),!r||r===e){i.textContent=e;return}let a=i.closest("[data-task-id]");if(!a)return;(await Gn(a.getAttribute("data-update-url")??"",new URLSearchParams({title:r}))).ok||(i.textContent=e)};i.addEventListener("blur",n,{once:!0}),i.addEventListener("keydown",r=>{r.key==="Enter"?(r.preventDefault(),i.blur()):r.key==="Escape"&&(i.textContent=e,i.removeAttribute("contenteditable"))},{once:!0})}function nc(i,e){for(let t of i){let n=document.querySelector(`[data-task-id="${t}"]`);if(!n)continue;n.classList.add("task-done"),n.querySelector(".task-actions")?.remove();let r=e==="completed"?"\u2713":"\u2717",a=e==="completed"?"task-status-completed":"task-status-discarded",c=n.querySelector(".task-title");c?.removeAttribute("contenteditable"),c?.classList.remove("js-editable-title"),c?.insertAdjacentHTML("afterend",`<span class="task-status-badge ${a}">${r}</span>`);let l=n.querySelector(".task-checkbox");l&&(l.checked=!0,l.disabled=!0,l.classList.remove("js-complete-check"))}}function ic(){document.getElementById("task-empty-state")?.remove()}function Bm(i,e){let t=document.getElementById("task-tree");if(t){if(ic(),e!==null){let n=Array.from(t.querySelectorAll(`[data-parent-id="${e}"]`)),r=n[n.length-1];if(r){r.insertAdjacentHTML("afterend",i);return}let a=t.querySelector(`[data-task-id="${e}"]`);if(a){a.insertAdjacentHTML("afterend",i);return}}t.insertAdjacentHTML("beforeend",i),rc(t)}}function rc(i){let e=0;i.querySelectorAll("[data-task-id]").forEach(t=>{let n=t.querySelector(".task-order-num");n&&(e++,n.textContent=String(e))})}var Ql=!1;function ec(i,e){let t=[];function n(r){i.querySelectorAll(`[data-parent-id="${r}"]`).forEach(a=>{t.push(a),n(Number(a.dataset.taskId))})}return n(e),t}function zm(){let i=document.getElementById("task-tree");if(!i)return;let e=i.dataset.reorderUrl??"";i.addEventListener("mousedown",t=>{Ql=!!t.target.closest(".task-drag-handle")}),i.addEventListener("dragstart",t=>{if(!Ql){t.preventDefault();return}let n=t.target.closest("[data-task-id]");if(!n){t.preventDefault();return}t.dataTransfer.effectAllowed="move",t.dataTransfer.setData("text/plain",n.dataset.taskId??""),n.classList.add("dragging")}),i.addEventListener("dragend",()=>{i.querySelectorAll(".dragging, .drop-before, .drop-into, .drop-after").forEach(t=>{t.classList.remove("dragging","drop-before","drop-into","drop-after")})}),i.addEventListener("dragover",t=>{t.preventDefault(),t.dataTransfer.dropEffect="move";let n=t.target.closest("[data-task-id]");if(!n)return;i.querySelectorAll(".drop-before, .drop-into, .drop-after").forEach(c=>{c.classList.remove("drop-before","drop-into","drop-after")});let r=n.getBoundingClientRect(),a=(t.clientY-r.top)/r.height;a<.3?n.classList.add("drop-before"):a<.7?n.classList.add("drop-into"):n.classList.add("drop-after")}),i.addEventListener("dragleave",t=>{i.contains(t.relatedTarget)||i.querySelectorAll(".drop-before, .drop-into, .drop-after").forEach(n=>{n.classList.remove("drop-before","drop-into","drop-after")})}),i.addEventListener("drop",async t=>{t.preventDefault();let n=Number(t.dataTransfer.getData("text/plain")),r=t.target.closest("[data-task-id]");if(!r||Number(r.dataset.taskId)===n)return;let a=i.querySelector(`[data-task-id="${n}"]`);if(!a)return;let c=r.classList.contains("drop-before"),l=r.classList.contains("drop-into"),h=l?r.dataset.taskId??"":r.dataset.parentId??"",d=a.dataset.parentId??"",s=h!==d,o=Math.round((parseFloat(a.style.paddingLeft)||0)/1.5),u=Math.round((parseFloat(r.style.paddingLeft)||0)/1.5),f=l?u+1:u,g=f-o,_=ec(i,n);if(new Set(_.map(E=>Number(E.dataset.taskId))).has(Number(r.dataset.taskId))){i.querySelectorAll(".dragging, .drop-before, .drop-into, .drop-after").forEach(E=>{E.classList.remove("dragging","drop-before","drop-into","drop-after")});return}let m=[a,..._],y=document.createDocumentFragment();if(m.forEach(E=>y.appendChild(E)),c)i.insertBefore(y,r);else{let E=ec(i,Number(r.dataset.taskId)),R=E.length?E[E.length-1]:r;i.insertBefore(y,R.nextSibling)}if(i.querySelectorAll(".dragging, .drop-before, .drop-into, .drop-after").forEach(E=>{E.classList.remove("dragging","drop-before","drop-into","drop-after")}),s||g!==0){a.dataset.parentId=h,a.style.paddingLeft=`${Math.max(0,f*1.5)}rem`,_.forEach(R=>{let w=parseFloat(R.style.paddingLeft)||0;R.style.paddingLeft=`${Math.max(0,w+g*1.5)}rem`});let E=a.querySelector(".task-order-num");if(!h&&!E){let R=document.createElement("span");R.className="task-order-num",R.textContent="0",a.querySelector(".task-drag-handle")?.insertAdjacentElement("afterend",R)}else h&&E&&E.remove()}rc(i);let v=Array.from(i.querySelectorAll("[data-task-id]")).map((E,R)=>{let w={id:Number(E.dataset.taskId),order:R};return E===a&&s&&(w.parent_id=h?Number(h):null),w});await Gn(e,new URLSearchParams({items:JSON.stringify(v)}))})}function km(){let i=document.getElementById("task-quick-add");i&&i.addEventListener("submit",async e=>{e.preventDefault();let t=i.querySelector("input[name='title']");if(!t?.value.trim()){t?.focus();return}let n=new FormData(i);n.set("scheduled_date",i.dataset.scheduledDate??"");let r=i.querySelector("[type='submit']");r&&(r.disabled=!0);let a=await Gn(i.dataset.createUrl,n);r&&(r.disabled=!1),a.ok&&(Bm(a.html,a.parent_id),t.value="",t.focus())})}function Hm(i,e,t){let n=document.createElement("form");return n.className="task-inline-add",n.innerHTML=`
  ...
  `,n.addEventListener("submit",async r=>{r.preventDefault();let a=n.querySelector("input[name='title']");if(!a?.value.trim()){a?.focus();return}let c=new URLSearchParams({title:a.value.trim(),parent:String(i),scheduled_date:e}),l=await Gn(t,c);l.ok&&(n.insertAdjacentHTML("beforebegin",l.html),n.remove(),ic())}),n.querySelector(".js-cancel-inline")?.addEventListener("click",()=>n.remove()),n}function Vm(){let i=document.getElementById("task-tree");i&&(i.addEventListener("contextmenu",e=>{let t=e.target.closest("[data-task-id]");if(!t||!t.querySelector(".js-edit-trigger"))return;e.preventDefault();let n=Number(t.dataset.taskId);if(ln===n){Qr();return}Kl(n,{x:e.clientX,y:e.clientY})}),i.addEventListener("click",async e=>{let t=e.target;if(t.classList.contains("js-complete-check")){let n=t.closest("[data-task-id]");if(!n)return;let r=n.getAttribute("data-complete-url");if(!r){t.checked=!1;return}t.disabled=!0;let a=await Gn(r,new URLSearchParams);a.ok?nc(a.affected_ids,"completed"):(t.checked=!1,t.disabled=!1);return}if(t.classList.contains("js-edit-trigger")){let n=Number(t.getAttribute("data-task-id"));if(ln===n){Qr();return}Kl(n,t);return}if(t.classList.contains("js-editable-title")){Om(t);return}if(t.classList.contains("js-add-subtask")){let n=Number(t.getAttribute("data-task-id")),r=t.getAttribute("data-date")??"",a=document.getElementById("task-quick-add")?.dataset.createUrl??"",c=i.querySelector(`[data-task-id="${n}"]`);if(!c)return;let l=c.nextElementSibling;if(l?.classList.contains("task-inline-add")){l.remove();return}let h=Hm(n,r,a);c.insertAdjacentElement("afterend",h),h.querySelector("input")?.focus();return}}))}function sc(){Dm(),Nm(),km(),Vm(),zm()}document.addEventListener("DOMContentLoaded",()=>{Jl(),$l(),Va(),sc(),document.body.classList.contains("home")&&Yl()});})();
