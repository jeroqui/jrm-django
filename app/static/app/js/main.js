...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Yo(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wa(),fragmentShader:`
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Zo(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wa(),fragmentShader:`
	...
	`}function yf(i){let e=new WeakMap,t=null;function n(l){if(l&&l.isTexture){let h=l.mapping,d=h===Br||h===zr,r=h===ui||h===hi;if(d||r)if(l.isRenderTargetTexture&&l.needsPMREMUpdate===!0){l.needsPMREMUpdate=!1;let o=e.get(l);return t===null&&(t=new Us(i)),o=d?t.fromEquirectangular(l,o):t.fromCubemap(l,o),e.set(l,o),o.texture}else{if(e.has(l))return e.get(l).texture;{let o=l.image;if(d&&o&&o.height>0||r&&o&&s(o)){t===null&&(t=new Us(i));let u=d?t.fromEquirectangular(l):t.fromCubemap(l);return e.set(l,u),l.addEventListener("dispose",a),u.texture}else return null}}}return l}function s(l){let h=0,d=6;for(let r=0;r<d;r++)l[r]!==void 0&&h++;return h===d}function a(l){let h=l.target;h.removeEventListener("dispose",a);let d=e.get(h);d!==void 0&&(e.delete(h),d.dispose())}function c(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:c}}function Mf(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){let s=t(n);return s===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function Sf(i,e,t,n){let s={},a=new WeakMap;function c(o){let u=o.target;u.index!==null&&e.remove(u.index);for(let g in u.attributes)e.remove(u.attributes[g]);for(let g in u.morphAttributes){let _=u.morphAttributes[g];for(let f=0,m=_.length;f<m;f++)e.remove(_[f])}u.removeEventListener("dispose",c),delete s[u.id];let p=a.get(u);p&&(e.remove(p),a.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function l(o,u){return s[u.id]===!0||(u.addEventListener("dispose",c),s[u.id]=!0,t.memory.geometries++),u}function h(o){let u=o.attributes;for(let g in u)e.update(u[g],i.ARRAY_BUFFER);let p=o.morphAttributes;for(let g in p){let _=p[g];for(let f=0,m=_.length;f<m;f++)e.update(_[f],i.ARRAY_BUFFER)}}function d(o){let u=[],p=o.index,g=o.attributes.position,_=0;if(p!==null){let y=p.array;_=p.version;for(let v=0,w=y.length;v<w;v+=3){let C=y[v+0],E=y[v+1],T=y[v+2];u.push(C,E,E,T,T,C)}}else if(g!==void 0){let y=g.array;_=g.version;for(let v=0,w=y.length/3-1;v<w;v+=3){let C=v+0,E=v+1,T=v+2;u.push(C,E,E,T,T,C)}}else return;let f=new(Ll(u)?Ps:Cs)(u,1);f.version=_;let m=a.get(o);m&&e.remove(m),a.set(o,f)}function r(o){let u=a.get(o);if(u){let p=o.index;p!==null&&u.version<p.version&&d(o)}else d(o);return a.get(o)}return{get:l,update:h,getWireframeAttribute:r}}function bf(i,e,t,n){let s=n.isWebGL2,a;function c(p){a=p}let l,h;function d(p){l=p.type,h=p.bytesPerElement}function r(p,g){i.drawElements(a,g,l,p*h),t.update(g,a,1)}function o(p,g,_){if(_===0)return;let f,m;if(s)f=i,m="drawElementsInstanced";else if(f=e.get("ANGLE_instanced_arrays"),m="drawElementsInstancedANGLE",f===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}f[m](a,g,l,p*h,_),t.update(g,a,_)}function u(p,g,_){if(_===0)return;let f=e.get("WEBGL_multi_draw");if(f===null)for(let m=0;m<_;m++)this.render(p[m]/h,g[m]);else{f.multiDrawElementsWEBGL(a,g,0,l,p,0,_);let m=0;for(let y=0;y<_;y++)m+=g[y];t.update(m,a,1)}}this.setMode=c,this.setIndex=d,this.render=r,this.renderInstances=o,this.renderMultiDraw=u}function Af(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(a,c,l){switch(t.calls++,c){case i.TRIANGLES:t.triangles+=l*(a/3);break;case i.LINES:t.lines+=l*(a/2);break;case i.LINE_STRIP:t.lines+=l*(a-1);break;case i.LINE_LOOP:t.lines+=l*a;break;case i.POINTS:t.points+=l*a;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",c);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Ef(i,e){return i[0]-e[0]}function wf(i,e){return Math.abs(e[1])-Math.abs(i[1])}function Tf(i,e,t){let n={},s=new Float32Array(8),a=new WeakMap,c=new ct,l=[];for(let d=0;d<8;d++)l[d]=[d,0];function h(d,r,o){let u=d.morphTargetInfluences;if(e.isWebGL2===!0){let p=r.morphAttributes.position||r.morphAttributes.normal||r.morphAttributes.color,g=p!==void 0?p.length:0,_=a.get(r);if(_===void 0||_.count!==g){let P=function(){q.dispose(),a.delete(r),r.removeEventListener("dispose",P)};_!==void 0&&_.texture.dispose();let y=r.morphAttributes.position!==void 0,v=r.morphAttributes.normal!==void 0,w=r.morphAttributes.color!==void 0,C=r.morphAttributes.position||[],E=r.morphAttributes.normal||[],T=r.morphAttributes.color||[],z=0;y===!0&&(z=1),v===!0&&(z=2),w===!0&&(z=3);let S=r.attributes.position.count*z,A=1;S>e.maxTextureSize&&(A=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);let k=new Float32Array(S*A*4*g),q=new Es(k,S,A,g);q.type=pn,q.needsUpdate=!0;let ee=z*4;for(let F=0;F<g;F++){let V=C[F],X=E[F],W=T[F],G=S*A*4*F;for(let $=0;$<V.count;$++){let Q=$*ee;y===!0&&(c.fromBufferAttribute(V,$),k[G+Q+0]=c.x,k[G+Q+1]=c.y,k[G+Q+2]=c.z,k[G+Q+3]=0),v===!0&&(c.fromBufferAttribute(X,$),k[G+Q+4]=c.x,k[G+Q+5]=c.y,k[G+Q+6]=c.z,k[G+Q+7]=0),w===!0&&(c.fromBufferAttribute(W,$),k[G+Q+8]=c.x,k[G+Q+9]=c.y,k[G+Q+10]=c.z,k[G+Q+11]=W.itemSize===4?c.w:1)}}_={count:g,texture:q,size:new He(S,A)},a.set(r,_),r.addEventListener("dispose",P)}let f=0;for(let y=0;y<u.length;y++)f+=u[y];let m=r.morphTargetsRelative?1:1-f;o.getUniforms().setValue(i,"morphTargetBaseInfluence",m),o.getUniforms().setValue(i,"morphTargetInfluences",u),o.getUniforms().setValue(i,"morphTargetsTexture",_.texture,t),o.getUniforms().setValue(i,"morphTargetsTextureSize",_.size)}else{let p=u===void 0?0:u.length,g=n[r.id];if(g===void 0||g.length!==p){g=[];for(let v=0;v<p;v++)g[v]=[v,0];n[r.id]=g}for(let v=0;v<p;v++){let w=g[v];w[0]=v,w[1]=u[v]}g.sort(wf);for(let v=0;v<8;v++)v<p&&g[v][1]?(l[v][0]=g[v][0],l[v][1]=g[v][1]):(l[v][0]=Number.MAX_SAFE_INTEGER,l[v][1]=0);l.sort(Ef);let _=r.morphAttributes.position,f=r.morphAttributes.normal,m=0;for(let v=0;v<8;v++){let w=l[v],C=w[0],E=w[1];C!==Number.MAX_SAFE_INTEGER&&E?(_&&r.getAttribute("morphTarget"+v)!==_[C]&&r.setAttribute("morphTarget"+v,_[C]),f&&r.getAttribute("morphNormal"+v)!==f[C]&&r.setAttribute("morphNormal"+v,f[C]),s[v]=E,m+=E):(_&&r.hasAttribute("morphTarget"+v)===!0&&r.deleteAttribute("morphTarget"+v),f&&r.hasAttribute("morphNormal"+v)===!0&&r.deleteAttribute("morphNormal"+v),s[v]=0)}let y=r.morphTargetsRelative?1:1-m;o.getUniforms().setValue(i,"morphTargetBaseInfluence",y),o.getUniforms().setValue(i,"morphTargetInfluences",s)}}return{update:h}}function Rf(i,e,t,n){let s=new WeakMap;function a(h){let d=n.render.frame,r=h.geometry,o=e.get(h,r);if(s.get(o)!==d&&(e.update(o),s.set(o,d)),h.isInstancedMesh&&(h.hasEventListener("dispose",l)===!1&&h.addEventListener("dispose",l),s.get(h)!==d&&(t.update(h.instanceMatrix,i.ARRAY_BUFFER),h.instanceColor!==null&&t.update(h.instanceColor,i.ARRAY_BUFFER),s.set(h,d))),h.isSkinnedMesh){let u=h.skeleton;s.get(u)!==d&&(u.update(),s.set(u,d))}return o}function c(){s=new WeakMap}function l(h){let d=h.target;d.removeEventListener("dispose",l),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:c}}var Ns=class extends Gt{constructor(e,t,n,s,a,c,l,h,d,r){if(r=r!==void 0?r:Dn,r!==Dn&&r!==di)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&r===Dn&&(n=fn),n===void 0&&r===di&&(n=In),super(null,s,a,c,l,h,r,n,d),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=l!==void 0?l:Mt,this.minFilter=h!==void 0?h:Mt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){let t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}},Nl=new Gt,Ol=new Ns(1,1);Ol.compareFunction=Pl;var Fl=new Es,Bl=new qr,zl=new Is,Jo=[],$o=[],Ko=new Float32Array(16),jo=new Float32Array(9),Qo=new Float32Array(4);function _i(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,a=Jo[s];if(a===void 0&&(a=new Float32Array(s),Jo[s]=a),e!==0){n.toArray(a,0);for(let c=1,l=0;c!==e;++c)l+=t,i[c].toArray(a,l)}return a}function st(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function rt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function qs(i,e){let t=$o[e];t===void 0&&(t=new Int32Array(e),$o[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Cf(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Pf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2fv(this.addr,e),rt(t,e)}}function Lf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(st(t,e))return;i.uniform3fv(this.addr,e),rt(t,e)}}function If(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4fv(this.addr,e),rt(t,e)}}function Df(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),rt(t,e)}else{if(st(t,n))return;Qo.set(n),i.uniformMatrix2fv(this.addr,!1,Qo),rt(t,n)}}function Uf(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),rt(t,e)}else{if(st(t,n))return;jo.set(n),i.uniformMatrix3fv(this.addr,!1,jo),rt(t,n)}}function Nf(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(st(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),rt(t,e)}else{if(st(t,n))return;Ko.set(n),i.uniformMatrix4fv(this.addr,!1,Ko),rt(t,n)}}function Of(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Ff(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2iv(this.addr,e),rt(t,e)}}function Bf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;i.uniform3iv(this.addr,e),rt(t,e)}}function zf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4iv(this.addr,e),rt(t,e)}}function kf(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Hf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(st(t,e))return;i.uniform2uiv(this.addr,e),rt(t,e)}}function Vf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(st(t,e))return;i.uniform3uiv(this.addr,e),rt(t,e)}}function Gf(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(st(t,e))return;i.uniform4uiv(this.addr,e),rt(t,e)}}function Wf(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let a=this.type===i.SAMPLER_2D_SHADOW?Ol:Nl;t.setTexture2D(e||a,s)}function Xf(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Bl,s)}function qf(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||zl,s)}function Yf(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Fl,s)}function Zf(i){switch(i){case 5126:return Cf;case 35664:return Pf;case 35665:return Lf;case 35666:return If;case 35674:return Df;case 35675:return Uf;case 35676:return Nf;case 5124:case 35670:return Of;case 35667:case 35671:return Ff;case 35668:case 35672:return Bf;case 35669:case 35673:return zf;case 5125:return kf;case 36294:return Hf;case 36295:return Vf;case 36296:return Gf;case 35678:case 36198:case 36298:case 36306:case 35682:return Wf;case 35679:case 36299:case 36307:return Xf;case 35680:case 36300:case 36308:case 36293:return qf;case 36289:case 36303:case 36311:case 36292:return Yf}}function Jf(i,e){i.uniform1fv(this.addr,e)}function $f(i,e){let t=_i(e,this.size,2);i.uniform2fv(this.addr,t)}function Kf(i,e){let t=_i(e,this.size,3);i.uniform3fv(this.addr,t)}function jf(i,e){let t=_i(e,this.size,4);i.uniform4fv(this.addr,t)}function Qf(i,e){let t=_i(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function ep(i,e){let t=_i(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function tp(i,e){let t=_i(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function np(i,e){i.uniform1iv(this.addr,e)}function ip(i,e){i.uniform2iv(this.addr,e)}function sp(i,e){i.uniform3iv(this.addr,e)}function rp(i,e){i.uniform4iv(this.addr,e)}function ap(i,e){i.uniform1uiv(this.addr,e)}function op(i,e){i.uniform2uiv(this.addr,e)}function lp(i,e){i.uniform3uiv(this.addr,e)}function cp(i,e){i.uniform4uiv(this.addr,e)}function up(i,e,t){let n=this.cache,s=e.length,a=qs(t,s);st(n,a)||(i.uniform1iv(this.addr,a),rt(n,a));for(let c=0;c!==s;++c)t.setTexture2D(e[c]||Nl,a[c])}function hp(i,e,t){let n=this.cache,s=e.length,a=qs(t,s);st(n,a)||(i.uniform1iv(this.addr,a),rt(n,a));for(let c=0;c!==s;++c)t.setTexture3D(e[c]||Bl,a[c])}function dp(i,e,t){let n=this.cache,s=e.length,a=qs(t,s);st(n,a)||(i.uniform1iv(this.addr,a),rt(n,a));for(let c=0;c!==s;++c)t.setTextureCube(e[c]||zl,a[c])}function fp(i,e,t){let n=this.cache,s=e.length,a=qs(t,s);st(n,a)||(i.uniform1iv(this.addr,a),rt(n,a));for(let c=0;c!==s;++c)t.setTexture2DArray(e[c]||Fl,a[c])}function pp(i){switch(i){case 5126:return Jf;case 35664:return $f;case 35665:return Kf;case 35666:return jf;case 35674:return Qf;case 35675:return ep;case 35676:return tp;case 5124:case 35670:return np;case 35667:case 35671:return ip;case 35668:case 35672:return sp;case 35669:case 35673:return rp;case 5125:return ap;case 36294:return op;case 36295:return lp;case 36296:return cp;case 35678:case 36198:case 36298:case 36306:case 35682:return up;case 35679:case 36299:case 36307:return hp;case 35680:case 36300:case 36308:case 36293:return dp;case 36289:case 36303:case 36311:case 36292:return fp}}var Jr=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Zf(t.type)}},$r=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=pp(t.type)}},Kr=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let a=0,c=s.length;a!==c;++a){let l=s[a];l.setValue(e,t[l.id],n)}}},Dr=/(\w+)(\])?(\[|\.)?/g;function el(i,e){i.seq.push(e),i.map[e.id]=e}function mp(i,e,t){let n=i.name,s=n.length;for(Dr.lastIndex=0;;){let a=Dr.exec(n),c=Dr.lastIndex,l=a[1],h=a[2]==="]",d=a[3];if(h&&(l=l|0),d===void 0||d==="["&&c+2===s){el(t,d===void 0?new Jr(l,i,e):new $r(l,i,e));break}else{let o=t.map[l];o===void 0&&(o=new Kr(l),el(t,o)),t=o}}}var ci=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){let a=e.getActiveUniform(t,s),c=e.getUniformLocation(t,a.name);mp(a,c,this)}}setValue(e,t,n,s){let a=this.map[t];a!==void 0&&a.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let a=0,c=t.length;a!==c;++a){let l=t[a],h=n[l.id];h.needsUpdate!==!1&&l.setValue(e,h.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,a=e.length;s!==a;++s){let c=e[s];c.id in t&&n.push(c)}return n}};function tl(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var gp=37297,_p=0;function vp(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let c=s;c<a;c++){let l=c+1;n.push(`${l===e?">":" "} ${l}: ${t[c]}`)}return n.join(`
`)}function xp(i){let e=We.getPrimaries(We.workingColorSpace),t=We.getPrimaries(i),n;switch(e===t?n="":e===ys&&t===xs?n="LinearDisplayP3ToLinearSRGB":e===xs&&t===ys&&(n="LinearSRGBToLinearDisplayP3"),i){case sn:case Xs:return[n,"LinearTransferOETF"];case ut:case Ea:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function nl(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";let a=/ERROR: 0:(\d+)/.exec(s);if(a){let c=parseInt(a[1]);return t.toUpperCase()+`

`+s+`

`+vp(i.getShaderSource(e),c)}else return s}function yp(i,e){let t=xp(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Mp(i,e){let t;switch(e){case Bc:t="Linear";break;case zc:t="Reinhard";break;case kc:t="OptimizedCineon";break;case Hc:t="ACESFilmic";break;case Gc:t="AgX";break;case Vc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Sp(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ai).join(`
`)}function bp(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(ai).join(`
`)}function Ap(i){let e=[];for(let t in i){let n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Ep(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let a=i.getActiveAttrib(e,s),c=a.name,l=1;a.type===i.FLOAT_MAT2&&(l=2),a.type===i.FLOAT_MAT3&&(l=3),a.type===i.FLOAT_MAT4&&(l=4),t[c]={type:a.type,location:i.getAttribLocation(e,c),locationSize:l}}return t}function ai(i){return i!==""}function il(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function sl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var wp=/^[ \t]*#include +<([\w\d./]+)>/gm;function jr(i){return i.replace(wp,Rp)}var Tp=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Rp(i,e){let t=Ie[e];if(t===void 0){let n=Tp.get(e);if(n!==void 0)t=Ie[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return jr(t)}var Cp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function rl(i){return i.replace(Cp,Pp)}function Pp(i,e,t,n){let s="";for(let a=parseInt(e);a<parseInt(t);a++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return s}function al(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Lp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===yl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Ma?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===en&&(e="SHADOWMAP_TYPE_VSM"),e}function Ip(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ui:case hi:e="ENVMAP_TYPE_CUBE";break;case Ws:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Dp(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case hi:e="ENVMAP_MODE_REFRACTION";break}return e}function Up(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Sa:e="ENVMAP_BLENDING_MULTIPLY";break;case Oc:e="ENVMAP_BLENDING_MIX";break;case Fc:e="ENVMAP_BLENDING_ADD";break}return e}function Np(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Op(i,e,t,n){let s=i.getContext(),a=t.defines,c=t.vertexShader,l=t.fragmentShader,h=Lp(t),d=Ip(t),r=Dp(t),o=Up(t),u=Np(t),p=t.isWebGL2?"":Sp(t),g=bp(t),_=Ap(a),f=s.createProgram(),m,y,v=t.glslVersion?"#version "+t.glslVersion+`
...
`),s=[];for(let l=0,h=n.length;l<h;l++){let d=n[l].trimStart();if(d.length===0)continue;let r=d.charAt(0);if(r!=="#")if(r==="v"){let o=d.split(kl);switch(o[0]){case"v":t.vertices.push(parseFloat(o[1]),parseFloat(o[2]),parseFloat(o[3])),o.length>=7?(Ys.setRGB(parseFloat(o[4]),parseFloat(o[5]),parseFloat(o[6])).convertSRGBToLinear(),t.colors.push(Ys.r,Ys.g,Ys.b)):t.colors.push(void 0,void 0,void 0);break;case"vn":t.normals.push(parseFloat(o[1]),parseFloat(o[2]),parseFloat(o[3]));break;case"vt":t.uvs.push(parseFloat(o[1]),parseFloat(o[2]));break}}else if(r==="f"){let u=d.slice(1).trim().split(kl),p=[];for(let _=0,f=u.length;_<f;_++){let m=u[_];if(m.length>0){let y=m.split("/");p.push(y)}}let g=p[0];for(let _=1,f=p.length-1;_<f;_++){let m=p[_],y=p[_+1];t.addFace(g[0],m[0],y[0],g[1],m[1],y[1],g[2],m[2],y[2])}}else if(r==="l"){let o=d.substring(1).trim().split(" "),u=[],p=[];if(d.indexOf("/")===-1)u=o;else for(let g=0,_=o.length;g<_;g++){let f=o[g].split("/");f[0]!==""&&u.push(f[0]),f[1]!==""&&p.push(f[1])}t.addLineGeometry(u,p)}else if(r==="p"){let u=d.slice(1).trim().split(" ");t.addPointGeometry(u)}else if((s=pm.exec(d))!==null){let o=(" "+s[0].slice(1).trim()).slice(1);t.startObject(o)}else if(gm.test(d))t.object.startMaterial(d.substring(7).trim(),t.materialLibraries);else if(mm.test(d))t.materialLibraries.push(d.substring(7).trim());else if(_m.test(d))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(r==="s"){if(s=d.split(" "),s.length>1){let u=s[1].trim().toLowerCase();t.object.smooth=u!=="0"&&u!=="off"}else t.object.smooth=!0;let o=t.object.currentMaterial();o&&(o.smooth=t.object.smooth)}else{if(d==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+d+'"')}}t.finalize();let a=new mn;if(a.materialLibraries=[].concat(t.materialLibraries),!(t.objects.length===1&&t.objects[0].geometry.vertices.length===0)===!0)for(let l=0,h=t.objects.length;l<h;l++){let d=t.objects[l],r=d.geometry,o=d.materials,u=r.type==="Line",p=r.type==="Points",g=!1;if(r.vertices.length===0)continue;let _=new Lt;_.setAttribute("position",new it(r.vertices,3)),r.normals.length>0&&_.setAttribute("normal",new it(r.normals,3)),r.colors.length>0&&(g=!0,_.setAttribute("color",new it(r.colors,3))),r.hasUVIndices===!0&&_.setAttribute("uv",new it(r.uvs,2));let f=[];for(let y=0,v=o.length;y<v;y++){let w=o[y],C=w.name+"_"+w.smooth+"_"+g,E=t.materials[C];if(this.materials!==null){if(E=this.materials.create(w.name),u&&E&&!(E instanceof Fn)){let T=new Fn;Tt.prototype.copy.call(T,E),T.color.copy(E.color),E=T}else if(p&&E&&!(E instanceof Sn)){let T=new Sn({size:10,sizeAttenuation:!1});Tt.prototype.copy.call(T,E),T.color.copy(E.color),T.map=E.map,E=T}}E===void 0&&(u?E=new Fn:p?E=new Sn({size:1,sizeAttenuation:!1}):E=new zs,E.name=w.name,E.flatShading=!w.smooth,E.vertexColors=g,t.materials[C]=E),f.push(E)}let m;if(f.length>1){for(let y=0,v=o.length;y<v;y++){let w=o[y];_.addGroup(w.groupStart,w.groupCount,y)}u?m=new Ui(_,f):p?m=new pi(_,f):m=new gt(_,f)}else u?m=new Ui(_,f[0]):p?m=new pi(_,f[0]):m=new gt(_,f[0]);m.name=d.name,a.add(m)}else if(t.vertices.length>0){let l=new Sn({size:1,sizeAttenuation:!1}),h=new Lt;h.setAttribute("position",new it(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(h.setAttribute("color",new it(t.colors,3)),l.vertexColors=!0);let d=new pi(h,l);a.add(d)}return a}};function Wl(i,e=1e-4){e=Math.max(e,Number.EPSILON);let t={},n=i.getIndex(),s=i.getAttribute("position"),a=n?n.count:s.count,c=0,l=Object.keys(i.attributes),h={},d={},r=[],o=["getX","getY","getZ","getW"],u=["setX","setY","setZ","setW"];for(let y=0,v=l.length;y<v;y++){let w=l[y],C=i.attributes[w];h[w]=new ht(new C.array.constructor(C.count*C.itemSize),C.itemSize,C.normalized);let E=i.morphAttributes[w];E&&(d[w]=new ht(new E.array.constructor(E.count*E.itemSize),E.itemSize,E.normalized))}let p=e*.5,g=Math.log10(1/e),_=Math.pow(10,g),f=p*_;for(let y=0;y<a;y++){let v=n?n.getX(y):y,w="";for(let C=0,E=l.length;C<E;C++){let T=l[C],z=i.getAttribute(T),S=z.itemSize;for(let A=0;A<S;A++)w+=`${~~(z[o[A]](v)*_+f)},`}if(w in t)r.push(t[w]);else{for(let C=0,E=l.length;C<E;C++){let T=l[C],z=i.getAttribute(T),S=i.morphAttributes[T],A=z.itemSize,k=h[T],q=d[T];for(let ee=0;ee<A;ee++){let P=o[ee],F=u[ee];if(k[F](c,z[P](v)),S)for(let V=0,X=S.length;V<X;V++)q[V][F](c,S[V][P](v))}}t[w]=c,r.push(c),c++}}let m=i.clone();for(let y in i.attributes){let v=h[y];if(m.setAttribute(y,new ht(v.array.slice(0,c*v.itemSize),v.itemSize,v.normalized)),y in d)for(let w=0;w<d[y].length;w++){let C=d[y][w];m.morphAttributes[y][w]=new ht(C.array.slice(0,c*C.itemSize),C.itemSize,C.normalized)}}return m.setIndex(r),m}var kn,Bi,Hn,on=null,Js=!1,Pa=0;function Xl(){let i=document.querySelector(".header-bg");if(!i)return;kn=new Os;let e=i.getBoundingClientRect();Bi=new St(75,e.width/e.height,.1,1e3),Bi.position.set(0,2,5),Hn=new Di({canvas:i,alpha:!0,antialias:!0}),Hn.setSize(e.width,e.height),Hn.setPixelRatio(window.devicePixelRatio),Hn.shadowMap.enabled=!0,Hn.shadowMap.type=Ma;let t=new Gs(16777215,.5);kn.add(t);let n=new Hs(16777215,4473924,.4);n.position.set(0,20,0),kn.add(n);let s=new Vs(16777215,1.2);s.position.set(10,20,15),s.castShadow=!0,s.shadow.mapSize.width=2048,s.shadow.mapSize.height=2048,s.shadow.radius=8;let a=s.shadow.camera;a.left=-10,a.right=10,a.top=10,a.bottom=-10,a.near=.5,a.far=50,kn.add(s);let c=new Ii(10,10),l=new Fs({opacity:.5}),h=new gt(c,l);h.rotation.x=-Math.PI/2,h.receiveShadow=!0,kn.add(h);let d=new Zs;d.setPath("/static/app/docs/"),d.load("estilografica.obj",r=>{on=r;let o=new Bs({color:8947848,metalness:.3,roughness:.5,side:kt,transparent:!1,opacity:1,depthWrite:!0,depthTest:!0});on.traverse(u=>{u instanceof gt&&(u.castShadow=!0,u.receiveShadow=!0,u.material=o,u.geometry&&(u.geometry=Wl(u.geometry),u.geometry.computeVertexNormals()))}),on.position.set(3,0,0),on.scale.set(.5,.5,.5),kn.add(on)}),window.addEventListener("mousedown",ym),window.addEventListener("mouseup",Mm),window.addEventListener("mousemove",Sm),window.addEventListener("resize",()=>bm(i)),ql()}function ym(i){Js=!0,Pa=i.clientX}function Mm(){Js=!1}function Sm(i){if(Js&&on){let e=i.clientX-Pa;on.rotation.y+=e*.01,Pa=i.clientX}}function bm(i){i.style.width="",i.style.height="";let e=i.getBoundingClientRect();Bi.aspect=e.width/e.height,Bi.updateProjectionMatrix(),Hn.setSize(e.width,e.height)}function ql(){requestAnimationFrame(ql),on&&!Js&&(on.rotation.y+=.003),Hn.render(kn,Bi)}function Yl(){let i=document.getElementById("navbar");if(!i)return;let e=i.querySelector(".navbar-hamburger");e&&(e.addEventListener("click",()=>{let t=i.classList.toggle("is-open");e.setAttribute("aria-expanded",String(t))}),document.addEventListener("click",t=>{i.contains(t.target)||(i.classList.remove("is-open"),e.setAttribute("aria-expanded","false"))}),i.querySelectorAll(".navbar-mobile-menu .navbar-btn").forEach(t=>{t.closest(".dropdown-wrapper")||t.addEventListener("click",()=>{i.classList.remove("is-open"),e.setAttribute("aria-expanded","false")})}))}function Zl(){document.querySelectorAll('a[href^="#"]').forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();let n=e.getAttribute("href")?.slice(1);if(n){let s=document.getElementById(n);s&&(s.scrollIntoView({behavior:"smooth",block:"start"}),history.pushState(null,"",`#${n}`))}})})}function Am(){let i=document.cookie.match(/csrftoken=([^;]+)/);return i?decodeURIComponent(i[1]):""}async function Ks(i,e){return(await fetch(i,{method:"POST",headers:{"X-CSRFToken":Am()},body:e})).json()}var bt=null,$s=null;function Em(){if(bt=document.getElementById("task-discard-modal"),!bt)return;let i=bt.querySelector("#modal-backdrop"),e=bt.querySelector("#modal-cancel"),t=bt.querySelector("#modal-confirm"),n=bt.querySelector("#modal-reason"),s=bt.querySelector("#modal-error"),a=()=>{bt.setAttribute("hidden",""),$s=null,n&&(n.value=""),s&&s.setAttribute("hidden","")};e?.addEventListener("click",a),i?.addEventListener("click",a),document.addEventListener("keydown",c=>{c.key==="Escape"&&bt&&!bt.hasAttribute("hidden")&&a()}),t?.addEventListener("click",async()=>{if(!$s)return;let c=n?.value.trim()??"";if(!c){s&&(s.textContent="Cal un motiu.",s.removeAttribute("hidden")),n?.focus();return}let l=t;l.disabled=!0;let d=document.querySelector(`[data-task-id="${$s}"]`)?.querySelector(".js-discard-trigger")?.getAttribute("data-discard-url")??"",r=new URLSearchParams({reason:c}),o=await Ks(d,r);l.disabled=!1,o.ok?(Jl(o.affected_ids,"discarded"),a()):s&&(s.textContent=o.error??"Error.",s.removeAttribute("hidden"))})}function wm(i,e){if(!bt)return;$s=i;let t=bt.querySelector("#modal-task-title");t&&(t.textContent=e);let n=bt.querySelector("#modal-reason");n&&(n.value="");let s=bt.querySelector("#modal-error");s&&s.setAttribute("hidden",""),bt.removeAttribute("hidden"),n?.focus()}function Jl(i,e){for(let t of i){let n=document.querySelector(`[data-task-id="${t}"]`);if(!n)continue;n.classList.add("task-done"),n.querySelector(".task-actions")?.remove();let s=e==="completed"?"\u2713":"\u2717",a=e==="completed"?"task-status-completed":"task-status-discarded";n.querySelector(".task-title")?.insertAdjacentHTML("afterend",`<span class="task-status-badge ${a}">${s}</span>`)}}function $l(){document.getElementById("task-empty-state")?.remove()}function Tm(i,e){let t=document.getElementById("task-tree");if(t){if($l(),e!==null){let n=t.querySelector(`[data-task-id="${e}"]`);if(n){n.insertAdjacentHTML("afterend",i);return}}t.insertAdjacentHTML("beforeend",i)}}function Rm(){let i=document.getElementById("task-quick-add");i&&i.addEventListener("submit",async e=>{e.preventDefault();let t=i.querySelector("input[name='title']");if(!t?.value.trim()){t?.focus();return}let n=new FormData(i);n.set("scheduled_date",i.dataset.scheduledDate??"");let s=i.querySelector("[type='submit']");s&&(s.disabled=!0);let a=await Ks(i.dataset.createUrl,n);s&&(s.disabled=!1),a.ok&&(Tm(a.html,a.parent_id),t.value="",t.focus())})}function Cm(i,e,t){let n=document.createElement("form");return n.className="task-inline-add",n.innerHTML=`
  ...
  `,n.addEventListener("submit",async s=>{s.preventDefault();let a=n.querySelector("input[name='title']");if(!a?.value.trim()){a?.focus();return}let c=new URLSearchParams({title:a.value.trim(),parent:String(i),scheduled_date:e}),l=await Ks(t,c);if(l.ok){let h=document.querySelector(`[data-task-id="${i}"]`);n.insertAdjacentHTML("beforebegin",l.html),n.remove(),$l()}}),n.querySelector(".js-cancel-inline")?.addEventListener("click",()=>n.remove()),n}function Pm(){let i=document.getElementById("task-tree");i&&i.addEventListener("click",async e=>{let t=e.target;if(t.classList.contains("js-complete-btn")){let n=t.getAttribute("data-complete-url");if(!n)return;t.disabled=!0;let s=await Ks(n,new URLSearchParams);s.ok?Jl(s.affected_ids,"completed"):t.disabled=!1}else if(t.classList.contains("js-discard-trigger")){let n=Number(t.getAttribute("data-task-id")),s=t.getAttribute("data-task-title")??"";wm(n,s)}else if(t.classList.contains("js-add-subtask")){let n=Number(t.getAttribute("data-task-id")),s=t.getAttribute("data-date")??"",a=document.getElementById("task-quick-add")?.dataset.createUrl??"",c=i.querySelector(`[data-task-id="${n}"]`);if(!c)return;let l=c.nextElementSibling;if(l?.classList.contains("task-inline-add")){l.remove();return}let h=Cm(n,s,a);c.insertAdjacentElement("afterend",h),h.querySelector("input")?.focus()}})}function Kl(){Em(),Rm(),Pm()}document.addEventListener("DOMContentLoaded",()=>{Zl(),Yl(),ka(),Kl(),document.body.classList.contains("home")&&Xl()});})();
